...
| GET | `/api/chats/order` | 无 | 当前 `sortMode`、`pinnedOrder` 与可选 `updatedAt` |
...
{"frame":"request","type":"desktop.awcp.manual","id":"dam-124","source":{"runId":"run-1","chatId":"chat-1","agentKey":"agent-1"},"payload":{}}
{"frame":"request","type":"desktop.awcp.manual","id":"dam-125","source":{"runId":"run-1","chatId":"chat-1","agentKey":"agent-1"},"payload":{"section":"orders.select"}}
{"frame":"request","type":"desktop.awcp.invoke","id":"daw-126","source":{"runId":"run-1","chatId":"chat-1","agentKey":"agent-1"},"payload":{"revision":"opaque-revision","action":"orders.select","args":{"ids":["order-1"]}}}
