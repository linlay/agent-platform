...
3. Read skill documentation first: When a skill applies, use file_read on its exact instructionsPath from the catalog before acting. Do not scan directories to discover installed skill locations.
