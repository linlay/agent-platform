...
func TestChatsLimitHTTPAndWebSocket(t *testing.T) {
	...
	seedAgentModeChat(t, store, "chat-react-limit", "loyw3v28", "agent-react", "", "agent", "REACT", 1_000)
	seedAgentModeChat(t, store, "chat-plan-limit", "loyw3v29", "agent-plan", "", "agent", "PLAN_EXECUTE", 2_000)
	seedAgentModeChat(t, store, "chat-team-limit", "loyw3v2a", "", "team-a", "team", "REACT", 3_000)
