...
func (s *Server) routes() {
	...
	s.router.HandleFunc("/api/admin/automations/create", s.method(http.MethodPost, s.handleAutomationCreate))
	s.router.HandleFunc("/api/admin/automations/update", s.method(http.MethodPost, s.handleAutomationUpdate))
	s.router.HandleFunc("/api/admin/automations/delete", s.method(http.MethodPost, s.handleAutomationDelete))
	s.router.HandleFunc("/api/admin/automations/toggle", s.method(http.MethodPost, s.handleAutomationToggle))
