...
func (s *Server) routes() {
	...
	s.router.HandleFunc("/api/chat/share", s.method(http.MethodPost, s.handleChatShareCreate))
	s.router.HandleFunc("/api/chat/shares", s.method(http.MethodGet, s.handleChatSharesList))
	s.router.HandleFunc("/api/chat/share/", s.method(http.MethodDelete, s.handleChatShareRevoke))
