...
func (s *Server) routes() {
	...
	s.router.HandleFunc("/api/admin/skills/v2", s.method(http.MethodGet, s.handleAdminSkillsV2))
	s.router.HandleFunc("/api/admin/skills/v2/detail", s.method(http.MethodGet, s.handleAdminSkillV2Detail))
	s.router.HandleFunc("/api/admin/skills/v2/create", s.method(http.MethodPost, s.handleAdminSkillV2Create))
	s.router.HandleFunc("/api/admin/skills/v2/delete", s.method(http.MethodPost, s.handleAdminSkillV2Delete))
	s.router.HandleFunc("/api/admin/skills/v2/file", s.handleAdminSkillV2File)
	s.router.HandleFunc("/api/admin/skills/v2/file/create", s.method(http.MethodPost, s.handleAdminSkillV2FileCreate))
	s.router.HandleFunc("/api/admin/skills/v2/file/mkdir", s.method(http.MethodPost, s.handleAdminSkillV2FileMkdir))
	s.router.HandleFunc("/api/admin/skills/v2/file/rename", s.method(http.MethodPost, s.handleAdminSkillV2FileRename))
	s.router.HandleFunc("/api/admin/skills/v2/file/delete", s.method(http.MethodPost, s.handleAdminSkillV2FileDelete))
	s.router.HandleFunc("/api/admin/skills/v2/file/upload", s.method(http.MethodPost, s.handleAdminSkillV2FileUpload))
	s.router.HandleFunc("/api/admin/skills/v2/file/download", s.method(http.MethodGet, s.handleAdminSkillFileDownload))
	s.router.HandleFunc("/api/admin/skills/v2/validate", s.method(http.MethodPost, s.handleAdminSkillV2Validate))
