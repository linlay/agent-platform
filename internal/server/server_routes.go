...
func (s *Server) routes() {
	...
	s.router.HandleFunc("/api/admin/agents/connectors", s.handleAdminAgentConnectors)
	...
	s.router.HandleFunc("/api/desktop/connector/auth", s.handlePersonalConnectorAuth)
	s.router.HandleFunc("/api/desktop/connector/auth/cancel", s.handlePersonalConnectorAuth)
	...
	s.router.HandleFunc("/api/admin/connectors/prepare", s.handleConnectorPrepare)
	...
	s.router.HandleFunc("/api/skills/order", s.handleSkillOrder)
	s.router.HandleFunc("/api/connectors/order", s.handleConnectorOrder)
	...
	s.router.HandleFunc("/api/automation/trigger", s.method(http.MethodPost, s.handleAutomationTrigger))
	...
	s.router.HandleFunc("/api/project/git/branches", s.handleProjectGitBranches)
