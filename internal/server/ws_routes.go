...
func (s *Server) registerWSRoutes(handler *ws.Handler) {
	...
	handler.RegisterRoute("/api/admin/agents", s.wsAdminAgents)
	handler.RegisterRoute("/api/admin/agents/detail", s.wsAdminAgentDetail)
	handler.RegisterRoute("/api/admin/agents/order", s.wsAdminAgentOrder)
	handler.RegisterRoute("/api/admin/registries", s.wsAdminRegistries)
	handler.RegisterRoute("/api/admin/registries/detail", s.wsAdminRegistryDetail)
	handler.RegisterRoute("/api/admin/registries/validate", s.wsAdminRegistryValidate)
	...
	handler.RegisterRoute("/api/terminal/open", s.wsTerminalOpen)
